    ...
    public partial class SiteMaster : MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    this.LinkButtonLogin.Text = "Sign in";
                    this.LinkButtonSpecialties.Visible = false;
                    this.LinkButtonSubjects.Visible = false;
                    this.LinkButtonStudents.Visible = false;
                    this.LinkButtonGrades.Visible = false;
                }
            }
        }
