...
namespace ProjectWFA
{
    public partial class FormGrade : Form
    {
        ...
        {
            Configurator configurator = new Configurator();
            configurator.SaveGrade(Convert.ToInt32(this.comboBoxStudent.SelectedValue), Convert.ToInt32(this.comboBoxSubject.SelectedValue), (int)this.numericUpDownFinalGrade.Value);
            this.Close();
        }
    }
}
